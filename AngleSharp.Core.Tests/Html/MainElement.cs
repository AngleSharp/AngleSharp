...
namespace AngleSharp.Core.Tests
{
    ...
    public class MainElementTests
    {
        ...
        public void MainElementClosesOpenParagraph()
        {
            ...
            Assert.AreEqual("main", dochtml1body1main1.NodeName);
            ...
            Assert.AreEqual("p", dochtml1body1main1p1.NodeName);
        ...
        public void MainClosesNestedParagraph()
        {
            ...
            Assert.AreEqual("main", dochtml1body1main0.NodeName);
            ...
            Assert.AreEqual("p", dochtml1body1main0p0.NodeName);
        ...
        public void MainElementInForeignSvgElement()
        {
            ...
            Assert.AreEqual("svg", dochtml1body1svg1.NodeName);
            ...
            Assert.AreEqual("x", dochtml1body1svg1x0.NodeName);
            ...
            Assert.AreEqual("g", dochtml1body1svg1x0g0.NodeName);
            ...
            Assert.AreEqual("a", dochtml1body1svg1x0g0a0.NodeName);
            ...
            Assert.AreEqual("main", dochtml1body1svg1x0g0a0main0.NodeName);
