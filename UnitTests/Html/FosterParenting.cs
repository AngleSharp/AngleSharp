...
<div></div>
            ...
            Assert.AreEqual(3, dochtml0body1div0.Childs.Length);
            ...
            var dochtml0body1div0div1 = dochtml0body1div0.Childs[1] as Element;
            Assert.AreEqual(0, dochtml0body1div0div1.Childs.Length);
            ...
            var dochtml0body1div0Text2 = dochtml0body1div0.Childs[2];
        ...
        public void FosterTableInTable()
        {
            ...
            var dochtml0body1table3 = dochtml0body1.Childs[3] as Element;
            Assert.AreEqual(0, dochtml0body1table3.Childs.Length);
        ...
        public void FosterDivsInBoldFormatting()
        {
            ...
            var dochtml0body1b0 = dochtml0body1.Childs[0] as Element;
            Assert.AreEqual(2, dochtml0body1b0.Childs.Length);
            ...
            var dochtml0body1b0Text0 = dochtml0body1b0.Childs[0];
            Assert.AreEqual(NodeType.Text, dochtml0body1b0Text0.NodeType);
            Assert.AreEqual("a", dochtml0body1b0Text0.TextContent);

            var dochtml0body1b0div1 = dochtml0body1b0.Childs[1] as Element;
            Assert.AreEqual(0, dochtml0body1b0div1.Childs.Length);
            ...
            Assert.AreEqual(2, dochtml0body1div1.Childs.Length);
            ...
            Assert.AreEqual(0, dochtml0body1div1b0.Childs.Length);
            ...
            var dochtml0body1div1Text1 = dochtml0body1div1.Childs[1];
        ...
        public void FosterParagraphAndDivInAnchor()
        {
            ...
            var dochtml0body1div1a0 = dochtml0body1div1.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1div1a0.Childs.Length);
            ...
            var dochtml0body1div1p1 = dochtml0body1div1.Childs[1] as Element;
            Assert.AreEqual(1, dochtml0body1div1p1.Childs.Length);
            ...
            var dochtml0body1div1p1a0 = dochtml0body1div1p1.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1div1p1a0.Childs.Length);
        ...
        public void FosterTitleInBody()
        {
            ...
            var dochtml1body1title0 = dochtml1body1.Childs[0] as Element;
            Assert.AreEqual(1, dochtml1body1title0.Childs.Length);
            ...
            var dochtml1body1title0Text0 = dochtml1body1title0.Childs[0];
        ...
        public void FosterMetaInTable()
        {
            ...
            var dochtml1body1meta0 = dochtml1body1.Childs[0] as Element;
            Assert.AreEqual(0, dochtml1body1meta0.Childs.Length);
        ...
        public void FosterMetaInTableInTableCell()
        {
            ...
            Assert.AreEqual(1, dochtml1body1table1tbody0tr0.Childs.Length);
            ...
            var dochtml1body1table1tbody0tr0td0 = dochtml1body1table1tbody0tr0.Childs[0] as Element;
            Assert.AreEqual(2, dochtml1body1table1tbody0tr0td0.Childs.Length);
            ...
            var dochtml1body1table1tbody0tr0td0meta0 = dochtml1body1table1tbody0tr0td0.Childs[0] as Element;
            Assert.AreEqual(0, dochtml1body1table1tbody0tr0td0meta0.Childs.Length);
            ...
            var dochtml1body1table1tbody0tr0td0table1 = dochtml1body1table1tbody0tr0td0.Childs[1] as Element;
            Assert.AreEqual(1, dochtml1body1table1tbody0tr0td0table1.Childs.Length);
            ...
            var dochtml1body1table1tbody0tr0td0table1Text0 = dochtml1body1table1tbody0tr0td0table1.Childs[0];
        ...
        public void FosterStyleInTableWithSpaces()
        {
            ...
            Assert.AreEqual(2, dochtml1body1table0.Childs.Length);
            ...
            var dochtml1body1table0style0 = dochtml1body1table0.Childs[0] as Element;
            Assert.AreEqual(1, dochtml1body1table0style0.Childs.Length);
            ...
            var dochtml1body1table0style0Text0 = dochtml1body1table0style0.Childs[0];
            ...
            var dochtml1body1table0Text1 = dochtml1body1table0.Childs[1];
        ...
        public void FosterScriptInTbodyInTable()
        {
            ...
            Assert.AreEqual(2, dochtml1body1table0tbody0.Childs.Length);
            ...
            var dochtml1body1table0tbody0script0 = dochtml1body1table0tbody0.Childs[0] as Element;
            Assert.AreEqual(1, dochtml1body1table0tbody0script0.Childs.Length);
            ...
            var dochtml1body1table0tbody0script0Text0 = dochtml1body1table0tbody0script0.Childs[0];
            ...
            var dochtml1body1table0tbody0Text1 = dochtml1body1table0tbody0.Childs[1];
        ...
        public void FosterAppletInParagraph()
        {
            ...
            var dochtml1body1p0applet0 = dochtml1body1p0.Childs[0] as Element;
            Assert.AreEqual(1, dochtml1body1p0applet0.Childs.Length);
            ...
            var dochtml1body1p0applet0p0 = dochtml1body1p0applet0.Childs[0] as Element;
            Assert.AreEqual(1, dochtml1body1p0applet0p0.Childs.Length);
            ...
            var dochtml1body1p0applet0p0Text0 = dochtml1body1p0applet0p0.Childs[0];
...
X</listing>");
            ...
            var dochtml1body1listing0 = dochtml1body1.Childs[0] as Element;
            Assert.AreEqual(1, dochtml1body1listing0.Childs.Length);
            ...
            var dochtml1body1listing0Text0 = dochtml1body1listing0.Childs[0];
        ...
        public void FosterSelectWithMisnestedInput()
        {
            ...
            var dochtml1body1input1 = dochtml1body1.Childs[1] as Element;
            Assert.AreEqual(0, dochtml1body1input1.Childs.Length);
            ...
            var dochtml1body1Text2 = dochtml1body1.Childs[2];
        ...
        public void FosterInputInTable()
        {
            ...
            var dochtml1body1table0input0 = dochtml1body1table0.Childs[0] as Element;
            Assert.AreEqual(0, dochtml1body1table0input0.Childs.Length);
        ...
        public void FosterInputAndTextInTable()
        {
            ...
            var dochtml1body1table1input0 = dochtml1body1table1.Childs[0] as Element;
            Assert.AreEqual(0, dochtml1body1table1input0.Childs.Length);
        ...
        public void FosterSpacesAndInputInTable()
        {
            ...
            var dochtml1body1table0input1 = dochtml1body1table0.Childs[1] as Element;
            Assert.AreEqual(0, dochtml1body1table0input1.Childs.Length);
        ...
        public void ParagraphClosedWrongInDiv()
        {
            ...
            var dochtml0body1div0p0 = dochtml0body1div0.Childs[0] as Element;
            Assert.AreEqual(1, dochtml0body1div0p0.Childs.Length);
            ...
            var dochtml0body1div0p0Text0 = dochtml0body1div0p0.Childs[0];
        ...
        public void FosterImplicitCellClosed()
        {
            ...
            Assert.AreEqual(2, dochtml0body1table0tbody0tr0td0.Childs.Length);
            ...
            var dochtml0body1table0tbody0tr0td0code0 = dochtml0body1table0tbody0tr0td0.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1table0tbody0tr0td0code0.Childs.Length);
            ...
            var dochtml0body1table0tbody0tr0td0Text1 = dochtml0body1table0tbody0tr0td0.Childs[1];
        ...
        public void FosterTextInTableAfterRow()
        {
            ...
            var dochtml0body1b0 = dochtml0body1.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1b0.Childs.Length);
            Assert.AreEqual(0, dochtml0body1b0.Attributes.Count);
            Assert.AreEqual("b", dochtml0body1b0.NodeName);
            Assert.AreEqual(NodeType.Element, dochtml0body1b0.NodeType);
            ...
            var dochtml0body1b1Text0 = dochtml0body1b1.Childs[0];
            Assert.AreEqual(NodeType.Text, dochtml0body1b1Text0.NodeType);
            Assert.AreEqual("bbb", dochtml0body1b1Text0.TextContent);

            var dochtml0body1table2 = dochtml0body1.Childs[2] as Element;
            Assert.AreEqual(1, dochtml0body1table2.Childs.Length);
            ...
            var dochtml0body1table2tbody0 = dochtml0body1table2.Childs[0] as Element;
            Assert.AreEqual(1, dochtml0body1table2tbody0.Childs.Length);
            ...
            var dochtml0body1table2tbody0tr0 = dochtml0body1table2tbody0.Childs[0] as Element;
            Assert.AreEqual(1, dochtml0body1table2tbody0tr0.Childs.Length);
            ...
            var dochtml0body1table2tbody0tr0td0 = dochtml0body1table2tbody0tr0.Childs[0] as Element;
            Assert.AreEqual(1, dochtml0body1table2tbody0tr0td0.Childs.Length);
            ...
            var dochtml0body1table2tbody0tr0td0Text0 = dochtml0body1table2tbody0tr0td0.Childs[0];
            ...
            var dochtml0body1b3 = dochtml0body1.Childs[3] as Element;
            Assert.AreEqual(1, dochtml0body1b3.Childs.Length);
            ...
            var dochtml0body1b3Text0 = dochtml0body1b3.Childs[0];
        ...
        public void FosterSpacesTextAndFormattingAfterRow()
        {
            ...
            var dochtml0body1table1tbody0 = dochtml0body1table1.Childs[0] as Element;
            Assert.AreEqual(2, dochtml0body1table1tbody0.Childs.Length);
            Assert.AreEqual(0, dochtml0body1table1tbody0.Attributes.Count);
            Assert.AreEqual("tbody", dochtml0body1table1tbody0.NodeName);
            Assert.AreEqual(NodeType.Element, dochtml0body1table1tbody0.NodeType);
            ...
            var dochtml0body1table1tbody0Text1 = dochtml0body1table1tbody0.Childs[1];
        ...
        public void FosterKeygenInSelect()
        {
            ...
            Assert.AreEqual(0, dochtml0body1select0.Childs.Length);
            ...
            var dochtml0body1keygen1 = dochtml0body1.Childs[1] as Element;
            Assert.AreEqual(0, dochtml0body1keygen1.Childs.Length);
