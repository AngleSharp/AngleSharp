...
namespace UnitTests.Html
{
    ...
    public class HtmlTemplateTests
    {
        ...
        public void TemplateNodeInBodyWithTextContent()
        {
            ...
            var dochtml0body1template0 = dochtml0body1.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1template0.Childs.Length);
            ...
            Assert.AreEqual(1, dochtml0body1template0Content.Childs.Length);
            Assert.AreEqual(NodeType.DocumentFragment, dochtml0body1template0Content.NodeType);

            var dochtml0body1template0ContentText0 = dochtml0body1template0Content.Childs[0];
        ...
        public void TemplateNodeStandaloneWithTextContent()
        {
            ...
            var dochtml0head0template0 = dochtml0head0.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0head0template0.Childs.Length);
            ...
            Assert.AreEqual(1, dochtml0head0template0Content.Childs.Length);
            Assert.AreEqual(NodeType.DocumentFragment, dochtml0head0template0Content.NodeType);

            var dochtml0head0template0ContentText0 = dochtml0head0template0Content.Childs[0];
        ...
        public void TemplateNodeEmptyFollowedByEmptyDiv()
        {
            ...
            var dochtml0head0template0Content = ((HTMLTemplateElement)dochtml0head0template0).Content;
            Assert.AreEqual(0, dochtml0head0template0Content.Childs.Length);
            Assert.AreEqual(NodeType.DocumentFragment, dochtml0head0template0Content.NodeType);
        ...
        public void TemplateInHeadWithDivElement()
        {
            ...
            var dochtml0head0template0Contentdiv0 = dochtml0head0template0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0head0template0Contentdiv0.Childs.Length);
        ...
        public void TemplateNodeInDivWithDivAndSpanMisclosed()
        {
            ...
            var dochtml0body1div0template0 = dochtml0body1div0.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1div0template0.Childs.Length);
            ...
            Assert.AreEqual(1, dochtml0body1div0template0Content.Childs.Length);
            Assert.AreEqual(NodeType.DocumentFragment, dochtml0body1div0template0Content.NodeType);

            var dochtml0body1div0template0Contentdiv0 = dochtml0body1div0template0Content.Childs[0] as Element;
            Assert.AreEqual(1, dochtml0body1div0template0Contentdiv0.Childs.Length);
            ...
            var dochtml0body1div0template0Contentdiv0span0 = dochtml0body1div0template0Contentdiv0.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1div0template0Contentdiv0span0.Childs.Length);
            ...
            var dochtml0body1div0b1 = dochtml0body1div0.Childs[1] as Element;
            Assert.AreEqual(0, dochtml0body1div0b1.Childs.Length);
        ...
        public void TemplateNodeInDivMisclosed()
        {
            ...
            var dochtml0body1div0template0ContentText0 = dochtml0body1div0template0Content.Childs[0];
        ...
        public void TemplateNodeInTableElement()
        {
            ...
            var dochtml0body1table0template0 = dochtml0body1table0.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1table0template0.Childs.Length);
            ...
            Assert.AreEqual(0, dochtml0body1table0template0Content.Childs.Length);
        ...
        public void TemplateNodeInDivUnderTableElement()
        {
            ...
            var dochtml0body1div0template0Content = ((HTMLTemplateElement)dochtml0body1div0template0).Content;
            Assert.AreEqual(0, dochtml0body1div0template0Content.Childs.Length);
            Assert.AreEqual(NodeType.DocumentFragment, dochtml0body1div0template0Content.NodeType);

            var dochtml0body1table1 = dochtml0body1.Childs[1] as Element;
            Assert.AreEqual(0, dochtml0body1table1.Childs.Length);
        ...
        public void TemplateNodeFollowedByDivInTable()
        {
            ...
            var dochtml0body1table1template0 = dochtml0body1table1.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1table1template0.Childs.Length);
            ...
            Assert.AreEqual(0, dochtml0body1table1template0Content.Childs.Length);
        ...
        public void TemplateNodeInTableAfterSpaces()
        {
            ...
            var dochtml0body1table0 = dochtml0body1.Childs[0] as Element;
            Assert.AreEqual(2, dochtml0body1table0.Childs.Length);
            Assert.AreEqual(0, dochtml0body1table0.Attributes.Count);
            Assert.AreEqual("table", dochtml0body1table0.NodeName);
            Assert.AreEqual(NodeType.Element, dochtml0body1table0.NodeType);

            var dochtml0body1table0Text0 = dochtml0body1table0.Childs[0];
            Assert.AreEqual(NodeType.Text, dochtml0body1table0Text0.NodeType);
            Assert.AreEqual("   ", dochtml0body1table0Text0.TextContent);

            var dochtml0body1table0template1 = dochtml0body1table0.Childs[1] as Element;
            Assert.AreEqual(0, dochtml0body1table0template1.Childs.Length);
            ...
            Assert.AreEqual(0, dochtml0body1table0template1Content.Childs.Length);
        ...
        public void TemplateNodeInTbody()
        {
            ...
            var dochtml0body1table0tbody0template0 = dochtml0body1table0tbody0.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1table0tbody0template0.Childs.Length);
            ...
            Assert.AreEqual(0, dochtml0body1table0tbody0template0Content.Childs.Length);
        ...
        public void TemplateNodeInThead()
        {
            ...
            var dochtml0body1table0thead0template0 = dochtml0body1table0thead0.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1table0thead0template0.Childs.Length);
            ...
            Assert.AreEqual(0, dochtml0body1table0thead0template0Content.Childs.Length);
        ...
        public void TemplateNodeInTfoot()
        {
            ...
            var dochtml0body1table0tfoot0 = dochtml0body1table0.Childs[0] as Element;
            Assert.AreEqual(1, dochtml0body1table0tfoot0.Childs.Length);
            ...
            var dochtml0body1table0tfoot0template0 = dochtml0body1table0tfoot0.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1table0tfoot0template0.Childs.Length);
            ...
            Assert.AreEqual(0, dochtml0body1table0tfoot0template0Content.Childs.Length);
        ...
        public void TemplateNodeInSelect()
        {
            ...
            var dochtml0body1select0template0 = dochtml0body1select0.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1select0template0.Childs.Length);
            ...
            Assert.AreEqual(0, dochtml0body1select0template0Content.Childs.Length);
        ...
        public void TemplateNodeWithOptionInSelect()
        {
            ...
            var dochtml0body1select0template0Content = ((HTMLTemplateElement)dochtml0body1select0template0).Content;
            Assert.AreEqual(1, dochtml0body1select0template0Content.Childs.Length);
            Assert.AreEqual(NodeType.DocumentFragment, dochtml0body1select0template0Content.NodeType);

            var dochtml0body1select0template0Contentoption0 = dochtml0body1select0template0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1select0template0Contentoption0.Childs.Length);
        ...
        public void TemplateNodeWithOptionsAndMisclosedSelect()
        {
            ...
            var dochtml0head0template0Content = ((HTMLTemplateElement)dochtml0head0template0).Content;
            Assert.AreEqual(2, dochtml0head0template0Content.Childs.Length);
            Assert.AreEqual(NodeType.DocumentFragment, dochtml0head0template0Content.NodeType);

            var dochtml0head0template0Contentoption0 = dochtml0head0template0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0head0template0Contentoption0.Childs.Length);
            ...
            var dochtml0head0template0Contentoption1 = dochtml0head0template0Content.Childs[1] as Element;
            Assert.AreEqual(0, dochtml0head0template0Contentoption1.Childs.Length);
        ...
        public void TemplateNodeInSelectFollowedByOption()
        {
            ...
            var dochtml0body1select0 = dochtml0body1.Childs[0] as Element;
            Assert.AreEqual(2, dochtml0body1select0.Childs.Length);
            Assert.AreEqual(0, dochtml0body1select0.Attributes.Count);
            Assert.AreEqual("select", dochtml0body1select0.NodeName);
            Assert.AreEqual(NodeType.Element, dochtml0body1select0.NodeType);
            ...
            var dochtml0body1select0option1 = dochtml0body1select0.Childs[1] as Element;
            Assert.AreEqual(0, dochtml0body1select0option1.Childs.Length);
        ...
        public void TemplateNodeInOptionOfSelect()
        {
            ...
            var dochtml0body1select0option0template0 = dochtml0body1select0option0.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1select0option0template0.Childs.Length);
            ...
            Assert.AreEqual(0, dochtml0body1select0option0template0Content.Childs.Length);
        ...
        public void TemplateNodeInInSelectAfterClosedOption()
        {
            ...
            var dochtml0body1select0option0 = dochtml0body1select0.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1select0option0.Childs.Length);
            Assert.AreEqual(0, dochtml0body1select0option0.Attributes.Count);
            Assert.AreEqual("option", dochtml0body1select0option0.NodeName);
            Assert.AreEqual(NodeType.Element, dochtml0body1select0option0.NodeType);

            var dochtml0body1select0template1 = dochtml0body1select0.Childs[1] as Element;
            Assert.AreEqual(0, dochtml0body1select0template1.Childs.Length);
            ...
            Assert.AreEqual(0, dochtml0body1select0template1Content.Childs.Length);
        ...
        public void TemplateNodeWithOpenOptionInSelectAfterClosedOption()
        {
            ...
            var dochtml0body1select0template1Content = ((HTMLTemplateElement)dochtml0body1select0template1).Content;
            Assert.AreEqual(1, dochtml0body1select0template1Content.Childs.Length);
            Assert.AreEqual(NodeType.DocumentFragment, dochtml0body1select0template1Content.NodeType);

            var dochtml0body1select0template1Contentoption0 = dochtml0body1select0template1Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1select0template1Contentoption0.Childs.Length);
        ...
        public void TemplateNodeWithOpenTdInThead()
        {
            ...
            var dochtml0body1table0thead0template0Content = ((HTMLTemplateElement)dochtml0body1table0thead0template0).Content;
            Assert.AreEqual(1, dochtml0body1table0thead0template0Content.Childs.Length);
            Assert.AreEqual(NodeType.DocumentFragment, dochtml0body1table0thead0template0Content.NodeType);

            var dochtml0body1table0thead0template0Contenttd0 = dochtml0body1table0thead0template0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1table0thead0template0Contenttd0.Childs.Length);
        ...
        public void TemplateNodeWithOpenTheadInTable()
        {
            ...
            var dochtml0body1table0template0Content = ((HTMLTemplateElement)dochtml0body1table0template0).Content;
            Assert.AreEqual(1, dochtml0body1table0template0Content.Childs.Length);
            Assert.AreEqual(NodeType.DocumentFragment, dochtml0body1table0template0Content.NodeType);

            var dochtml0body1table0template0Contentthead0 = dochtml0body1table0template0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1table0template0Contentthead0.Childs.Length);
        ...
        public void TemplateNodeWithOpenTdAndMisclosedTrInTable()
        {
            ...
            var dochtml0body1table0template0Contenttd0 = dochtml0body1table0template0Content.Childs[0] as Element;
            Assert.AreEqual(1, dochtml0body1table0template0Contenttd0.Childs.Length);
            ...
            var dochtml0body1table0template0Contenttd0div0 = dochtml0body1table0template0Contenttd0.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1table0template0Contenttd0div0.Childs.Length);
        ...
        public void TemplateNodeWithOpenTrInTheadInTable()
        {
            ...
            var dochtml0body1table0thead0template0Contenttr0 = dochtml0body1table0thead0template0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1table0thead0template0Contenttr0.Childs.Length);
        ...
        public void TemplateNodeWithOpenTrInTable()
        {
            ...
            var dochtml0body1table0template0Contenttr0 = dochtml0body1table0template0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1table0template0Contenttr0.Childs.Length);
        ...
        public void TemplateNodeWithOpenTdInTrInTable()
        {
            ...
            var dochtml0body1table0tbody0tr0template0 = dochtml0body1table0tbody0tr0.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1table0tbody0tr0template0.Childs.Length);
            ...
            Assert.AreEqual(1, dochtml0body1table0tbody0tr0template0Content.Childs.Length);
            Assert.AreEqual(NodeType.DocumentFragment, dochtml0body1table0tbody0tr0template0Content.NodeType);

            var dochtml0body1table0tbody0tr0template0Contenttd0 = dochtml0body1table0tbody0tr0template0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1table0tbody0tr0template0Contenttd0.Childs.Length);
        ...
        public void TemplateNodesNestedWithClosedElementsInTable()
        {
            ...
            var dochtml0body1table0template0Contenttr0 = dochtml0body1table0template0Content.Childs[0] as Element;
            Assert.AreEqual(1, dochtml0body1table0template0Contenttr0.Childs.Length);
            Assert.AreEqual(0, dochtml0body1table0template0Contenttr0.Attributes.Count);
            Assert.AreEqual("tr", dochtml0body1table0template0Contenttr0.NodeName);
            Assert.AreEqual(NodeType.Element, dochtml0body1table0template0Contenttr0.NodeType);

            var dochtml0body1table0template0Contenttr0template0 = dochtml0body1table0template0Contenttr0.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1table0template0Contenttr0template0.Childs.Length);
            ...
            Assert.AreEqual(1, dochtml0body1table0template0Contenttr0template0Content.Childs.Length);
            Assert.AreEqual(NodeType.DocumentFragment, dochtml0body1table0template0Contenttr0template0Content.NodeType);

            var dochtml0body1table0template0Contenttr0template0Contenttd0 = dochtml0body1table0template0Contenttr0template0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1table0template0Contenttr0template0Contenttd0.Childs.Length);
        ...
        public void TemplateNodeWithOpenTdInTable()
        {
            ...
            var dochtml0body1table0template0Contenttd0 = dochtml0body1table0template0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1table0template0Contenttd0.Childs.Length);
            Assert.AreEqual(0, dochtml0body1table0template0Contenttd0.Attributes.Count);
            Assert.AreEqual("td", dochtml0body1table0template0Contenttd0.NodeName);
            Assert.AreEqual(NodeType.Element, dochtml0body1table0template0Contenttd0.NodeType);
        }
        ...
        public void TemplateNodeWithTdInBody()
        {
            ...
            var dochtml0body1template0Contenttd0 = dochtml0body1template0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1template0Contenttd0.Childs.Length);
        ...
        public void TemplateNodesMisnestedContent()
        {
            ...
            var dochtml0body1template0Content = ((HTMLTemplateElement)dochtml0body1template0).Content;
            Assert.AreEqual(2, dochtml0body1template0Content.Childs.Length);
            Assert.AreEqual(NodeType.DocumentFragment, dochtml0body1template0Content.NodeType);

            var dochtml0body1template0Contenttemplate0 = dochtml0body1template0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1template0Contenttemplate0.Childs.Length);
            ...
            Assert.AreEqual(1, dochtml0body1template0Contenttemplate0Content.Childs.Length);
            Assert.AreEqual(NodeType.DocumentFragment, dochtml0body1template0Contenttemplate0Content.NodeType);

            var dochtml0body1template0Contenttemplate0Contenttr0 = dochtml0body1template0Contenttemplate0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1template0Contenttemplate0Contenttr0.Childs.Length);
            ...
            var dochtml0body1template0Contenttd1 = dochtml0body1template0Content.Childs[1] as Element;
            Assert.AreEqual(0, dochtml0body1template0Contenttd1.Childs.Length);
        ...
        public void TemplateNodeWithColInColgroupInTable()
        {
            ...
            var dochtml0body1table0colgroup0 = dochtml0body1table0.Childs[0] as Element;
            Assert.AreEqual(1, dochtml0body1table0colgroup0.Childs.Length);
            ...
            var dochtml0body1table0colgroup0template0 = dochtml0body1table0colgroup0.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1table0colgroup0template0.Childs.Length);
            ...
            Assert.AreEqual(1, dochtml0body1table0colgroup0template0Content.Childs.Length);
            Assert.AreEqual(NodeType.DocumentFragment, dochtml0body1table0colgroup0template0Content.NodeType);

            var dochtml0body1table0colgroup0template0Contentcol0 = dochtml0body1table0colgroup0template0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1table0colgroup0template0Contentcol0.Childs.Length);
        ...
        public void TemplateNodeWithFrameInFrameset()
        {
            ...
            Assert.AreEqual(1, dochtml0frameset1.Childs.Length);
        ...
        public void TemplateWithDivFramesetAndSpan()
        {
            ...
            var dochtml0head0template0Contentdiv0 = dochtml0head0template0Content.Childs[0] as Element;
            Assert.AreEqual(1, dochtml0head0template0Contentdiv0.Childs.Length);
            Assert.AreEqual(0, dochtml0head0template0Contentdiv0.Attributes.Count);
            Assert.AreEqual("div", dochtml0head0template0Contentdiv0.NodeName);
            Assert.AreEqual(NodeType.Element, dochtml0head0template0Contentdiv0.NodeType);

            var dochtml0head0template0Contentdiv0span0 = dochtml0head0template0Contentdiv0.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0head0template0Contentdiv0span0.Childs.Length);
            ...
            var dochtml0head0template0Contentspan1 = dochtml0head0template0Content.Childs[1] as Element;
            Assert.AreEqual(0, dochtml0head0template0Contentspan1.Childs.Length);
        ...
        public void TemplateNodeInBodyWithDivFramesetSpan()
        {
            ...
            var dochtml0body1template0Contentdiv0 = dochtml0body1template0Content.Childs[0] as Element;
            Assert.AreEqual(1, dochtml0body1template0Contentdiv0.Childs.Length);
            ...
            var dochtml0body1template0Contentdiv0span0 = dochtml0body1template0Contentdiv0.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1template0Contentdiv0span0.Childs.Length);
            ...
            var dochtml0body1template0Contentspan1 = dochtml0body1template0Content.Childs[1] as Element;
            Assert.AreEqual(0, dochtml0body1template0Contentspan1.Childs.Length);
        ...
        public void TemplateNodeInBodyWithScriptAndTd()
        {
            ...
            var dochtml0body1template0Contentscript0 = dochtml0body1template0Content.Childs[0] as Element;
            Assert.AreEqual(1, dochtml0body1template0Contentscript0.Childs.Length);
            ...
            var dochtml0body1template0Contentscript0Text0 = dochtml0body1template0Contentscript0.Childs[0];
        ...
        public void TemplateNodeInBodyWithTrDiv()
        {
            ...
            var dochtml0body1template0Contenttr0 = dochtml0body1template0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1template0Contenttr0.Childs.Length);
            ...
            var dochtml0body1template0Contentdiv1 = dochtml0body1template0Content.Childs[1] as Element;
            Assert.AreEqual(0, dochtml0body1template0Contentdiv1.Childs.Length);
        ...
        public void TemplateNodeInBodyWithTrTd()
        {
            ...
            var dochtml0body1template0Contenttr1 = dochtml0body1template0Content.Childs[1] as Element;
            Assert.AreEqual(1, dochtml0body1template0Contenttr1.Childs.Length);
            ...
            var dochtml0body1template0Contenttr1td0 = dochtml0body1template0Contenttr1.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1template0Contenttr1td0.Childs.Length);
        ...
        public void TemplateNodeInBodyWithTrTbodyTr()
        {
            ...
            var dochtml0body1template0Contenttr1 = dochtml0body1template0Content.Childs[1] as Element;
            Assert.AreEqual(0, dochtml0body1template0Contenttr1.Childs.Length);
            Assert.AreEqual(0, dochtml0body1template0Contenttr1.Attributes.Count);
            Assert.AreEqual("tr", dochtml0body1template0Contenttr1.NodeName);
            Assert.AreEqual(NodeType.Element, dochtml0body1template0Contenttr1.NodeType);
        }
        ...
        public void TemplateNodeInBodyWithTheadCaptionTbody()
        {
            ...
            var dochtml0body1template0Content = ((HTMLTemplateElement)dochtml0body1template0).Content;
            Assert.AreEqual(3, dochtml0body1template0Content.Childs.Length);
            Assert.AreEqual(NodeType.DocumentFragment, dochtml0body1template0Content.NodeType);

            var dochtml0body1template0Contentthead0 = dochtml0body1template0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1template0Contentthead0.Childs.Length);
            ...
            var dochtml0body1template0Contentcaption1 = dochtml0body1template0Content.Childs[1] as Element;
            Assert.AreEqual(0, dochtml0body1template0Contentcaption1.Childs.Length);
            ...
            var dochtml0body1template0Contenttbody2 = dochtml0body1template0Content.Childs[2] as Element;
            Assert.AreEqual(0, dochtml0body1template0Contenttbody2.Childs.Length);
        ...
        public void TemplateNodeInBodyWithTheadMisclosedTableTbody()
        {
            ...
            var dochtml0body1template0Contenttbody1 = dochtml0body1template0Content.Childs[1] as Element;
            Assert.AreEqual(0, dochtml0body1template0Contenttbody1.Childs.Length);
        ...
        public void TemplateNodeInBodyWithDivTr()
        {
            ...
            var dochtml0body1template0Contentdiv0 = dochtml0body1template0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1template0Contentdiv0.Childs.Length);
            Assert.AreEqual(0, dochtml0body1template0Contentdiv0.Attributes.Count);
            Assert.AreEqual("div", dochtml0body1template0Contentdiv0.NodeName);
            Assert.AreEqual(NodeType.Element, dochtml0body1template0Contentdiv0.NodeType);
        }
        ...
        public void TemplateNodeInBodyWithEmAndText()
        {
            ...
            var dochtml0body1template0Contentem0 = dochtml0body1template0Content.Childs[0] as Element;
            Assert.AreEqual(1, dochtml0body1template0Contentem0.Childs.Length);
            ...
            var dochtml0body1template0Contentem0Text0 = dochtml0body1template0Contentem0.Childs[0];
        ...
        public void TemplateNodeInBodyWithComment()
        {
            ...
            var dochtml0body1template0ContentComment0 = dochtml0body1template0Content.Childs[0];
        ...
        public void TemplateNodeInBodyWithStyleTd()
        {
            ...
            var dochtml0body1template0Contentstyle0 = dochtml0body1template0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1template0Contentstyle0.Childs.Length);
        ...
        public void TemplateNodeInBodyWithMetaTd()
        {
            ...
            var dochtml0body1template0Contentmeta0 = dochtml0body1template0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1template0Contentmeta0.Childs.Length);
        ...
        public void TemplateNodeInBodyWithLinkTd()
        {
            ...
            var dochtml0body1template0Contentlink0 = dochtml0body1template0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1template0Contentlink0.Childs.Length);
        ...
        public void TemplateNodeInHtmlWithAttrWithColAndOtherHtml()
        {
            ...
            var dochtml0head0template0Contentcol0 = dochtml0head0template0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0head0template0Contentcol0.Childs.Length);
            ...
            var dochtml0head0template0Contentcol1 = dochtml0head0template0Content.Childs[1] as Element;
            Assert.AreEqual(0, dochtml0head0template0Contentcol1.Childs.Length);
        ...
        public void TemplateNodeInBodyWithTrAndNestedTemplate()
        {
            ...
            var dochtml0body1template0Contenttemplate1 = dochtml0body1template0Content.Childs[1] as Element;
            Assert.AreEqual(0, dochtml0body1template0Contenttemplate1.Childs.Length);
            ...
            Assert.AreEqual(0, dochtml0body1template0Contenttemplate1Content.Childs.Length);
            Assert.AreEqual(NodeType.DocumentFragment, dochtml0body1template0Contenttemplate1Content.NodeType);

            var dochtml0body1template0Contenttr2 = dochtml0body1template0Content.Childs[2] as Element;
            Assert.AreEqual(1, dochtml0body1template0Contenttr2.Childs.Length);
            ...
            var dochtml0body1template0Contenttr2td0 = dochtml0body1template0Contenttr2.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1template0Contenttr2td0.Childs.Length);
        ...
        public void TemplateNodeInBodyWithTheadTrTfootNestedTemplateWithTr()
        {
            ...
            var dochtml0body1template0Content = ((HTMLTemplateElement)dochtml0body1template0).Content;
            Assert.AreEqual(4, dochtml0body1template0Content.Childs.Length);
            Assert.AreEqual(NodeType.DocumentFragment, dochtml0body1template0Content.NodeType);
            ...
            var dochtml0body1template0Contenttemplate1Content = ((HTMLTemplateElement)dochtml0body1template0Contenttemplate1).Content;
            Assert.AreEqual(1, dochtml0body1template0Contenttemplate1Content.Childs.Length);
            Assert.AreEqual(NodeType.DocumentFragment, dochtml0body1template0Contenttemplate1Content.NodeType);

            var dochtml0body1template0Contenttemplate1Contenttr0 = dochtml0body1template0Contenttemplate1Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1template0Contenttemplate1Contenttr0.Childs.Length);
            ...
            var dochtml0body1template0Contenttbody2 = dochtml0body1template0Content.Childs[2] as Element;
            Assert.AreEqual(1, dochtml0body1template0Contenttbody2.Childs.Length);
            Assert.AreEqual(0, dochtml0body1template0Contenttbody2.Attributes.Count);
            Assert.AreEqual("tbody", dochtml0body1template0Contenttbody2.NodeName);
            Assert.AreEqual(NodeType.Element, dochtml0body1template0Contenttbody2.NodeType);

            var dochtml0body1template0Contenttbody2tr0 = dochtml0body1template0Contenttbody2.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1template0Contenttbody2tr0.Childs.Length);
            ...
            var dochtml0body1template0Contenttfoot3 = dochtml0body1template0Content.Childs[3] as Element;
            Assert.AreEqual(0, dochtml0body1template0Contenttfoot3.Childs.Length);
        ...
        public void TemplateNodeInBodyWithNestedTemplateBTemplateAndText()
        {
            ...
            var dochtml0body1template0Contenttemplate0Contentb0 = dochtml0body1template0Contenttemplate0Content.Childs[0] as Element;
            Assert.AreEqual(1, dochtml0body1template0Contenttemplate0Contentb0.Childs.Length);
            ...
            var dochtml0body1template0Contenttemplate0Contentb0template0 = dochtml0body1template0Contenttemplate0Contentb0.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1template0Contenttemplate0Contentb0template0.Childs.Length);
            ...
            Assert.AreEqual(0, dochtml0body1template0Contenttemplate0Contentb0template0Content.Childs.Length);
            Assert.AreEqual(NodeType.DocumentFragment, dochtml0body1template0Contenttemplate0Contentb0template0Content.NodeType);

            var dochtml0body1template0ContentText1 = dochtml0body1template0Content.Childs[1];
        ...
        public void TemplateNodeWithColColgroupInBody()
        {
            ...
            var dochtml0body1template0Contentcol0 = dochtml0body1template0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1template0Contentcol0.Childs.Length);
        ...
        public void TemplateNodeInBodyWithIAndMenuAndText()
        {
            ...
            var dochtml0body1template0Contenti0 = dochtml0body1template0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1template0Contenti0.Childs.Length);
            ...
            var dochtml0body1template0Contentmenu1 = dochtml0body1template0Content.Childs[1] as Element;
            Assert.AreEqual(1, dochtml0body1template0Contentmenu1.Childs.Length);
            ...
            var dochtml0body1template0Contentmenu1i0 = dochtml0body1template0Contentmenu1.Childs[0] as Element;
            Assert.AreEqual(1, dochtml0body1template0Contentmenu1i0.Childs.Length);
            ...
            var dochtml0body1template0Contentmenu1i0Text0 = dochtml0body1template0Contentmenu1i0.Childs[0];
        ...
        public void TemplateNodeWithMisclosedDivDivTextAndNestedTemplateInBody()
        {
            ...
            var dochtml0body1template0Contentdiv0Text0 = dochtml0body1template0Contentdiv0.Childs[0];
        ...
        public void TemplateNodeInBodyWithMisclosedDivTrTdAndText()
        {
            ...
            var dochtml0body1div0template0Contenttr0 = dochtml0body1div0template0Content.Childs[0] as Element;
            Assert.AreEqual(1, dochtml0body1div0template0Contenttr0.Childs.Length);
            ...
            var dochtml0body1div0template0Contenttr0td0 = dochtml0body1div0template0Contenttr0.Childs[0] as Element;
            Assert.AreEqual(1, dochtml0body1div0template0Contenttr0td0.Childs.Length);
            ...
            var dochtml0body1div0template0Contenttr0td0Text0 = dochtml0body1div0template0Contenttr0td0.Childs[0];
        ...
        public void TemplateNodeMisclosedFigcaptionAndSubAndTable()
        {
            ...
            var dochtml0head0template0Contentsub0 = dochtml0head0template0Content.Childs[0] as Element;
            Assert.AreEqual(1, dochtml0head0template0Contentsub0.Childs.Length);
            ...
            var dochtml0head0template0Contentsub0table0 = dochtml0head0template0Contentsub0.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0head0template0Contentsub0table0.Childs.Length);
        ...
        public void TemplateNodeEmptyNested()
        {
            ...
            var dochtml0head0template0Contenttemplate0 = dochtml0head0template0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0head0template0Contenttemplate0.Childs.Length);
            ...
            Assert.AreEqual(0, dochtml0head0template0Contenttemplate0Content.Childs.Length);
        ...
        public void TemplateNodeNestedWithDiv()
        {
            ...
            var dochtml0head0template0Contenttemplate0Content = ((HTMLTemplateElement)dochtml0head0template0Contenttemplate0).Content;
            Assert.AreEqual(1, dochtml0head0template0Contenttemplate0Content.Childs.Length);
            Assert.AreEqual(NodeType.DocumentFragment, dochtml0head0template0Contenttemplate0Content.NodeType);

            var dochtml0head0template0Contenttemplate0Contentdiv0 = dochtml0head0template0Contenttemplate0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0head0template0Contenttemplate0Contentdiv0.Childs.Length);
        ...
        public void TemplateNodeNestedWithTable()
        {
            ...
            var dochtml0head0template0Contenttemplate0Contenttable0 = dochtml0head0template0Contenttemplate0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0head0template0Contenttemplate0Contenttable0.Childs.Length);
        ...
        public void TemplateNodeNestedWithTbody()
        {
            ...
            var dochtml0head0template0Contenttemplate0Contenttbody0 = dochtml0head0template0Contenttemplate0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0head0template0Contenttemplate0Contenttbody0.Childs.Length);
        ...
        public void TemplateNodeNestedWithTr()
        {
            ...
            var dochtml0head0template0Contenttemplate0Contenttr0 = dochtml0head0template0Contenttemplate0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0head0template0Contenttemplate0Contenttr0.Childs.Length);
        ...
        public void TemplateNodeNestedWithTd()
        {
            ...
            var dochtml0head0template0Contenttemplate0Contenttd0 = dochtml0head0template0Contenttemplate0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0head0template0Contenttemplate0Contenttd0.Childs.Length);
        ...
        public void TemplateNodeNestedWithCaption()
        {
            ...
            var dochtml0head0template0Contenttemplate0Contentcaption0 = dochtml0head0template0Contenttemplate0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0head0template0Contenttemplate0Contentcaption0.Childs.Length);
        ...
        public void TemplateNodeNestedWithColgroup()
        {
            ...
            var dochtml0head0template0Contenttemplate0Contentcolgroup0 = dochtml0head0template0Contenttemplate0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0head0template0Contenttemplate0Contentcolgroup0.Childs.Length);
        ...
        public void TemplateNodeNestedWithCol()
        {
            ...
            var dochtml0head0template0Contenttemplate0Contentcol0 = dochtml0head0template0Contenttemplate0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0head0template0Contenttemplate0Contentcol0.Childs.Length);
        ...
        public void TemplateNodeNestedWithSelectInTbody()
        {
            ...
            var dochtml0head0template0Contenttemplate0Content = ((HTMLTemplateElement)dochtml0head0template0Contenttemplate0).Content;
            Assert.AreEqual(2, dochtml0head0template0Contenttemplate0Content.Childs.Length);
            Assert.AreEqual(NodeType.DocumentFragment, dochtml0head0template0Contenttemplate0Content.NodeType);
            ...
            var dochtml0head0template0Contenttemplate0Contentselect1 = dochtml0head0template0Contenttemplate0Content.Childs[1] as Element;
            Assert.AreEqual(0, dochtml0head0template0Contenttemplate0Contentselect1.Childs.Length);
        ...
        public void TemplateNodeNestedWithTextInTable()
        {
            ...
            var dochtml0head0template0Contenttemplate0ContentText0 = dochtml0head0template0Contenttemplate0Content.Childs[0];
            ...
            var dochtml0head0template0Contenttemplate0Contenttable1 = dochtml0head0template0Contenttemplate0Content.Childs[1] as Element;
            Assert.AreEqual(0, dochtml0head0template0Contenttemplate0Contenttable1.Childs.Length);
        ...
        public void TemplateNodeNestedWithScriptUnclosed()
        {
            ...
            var dochtml0head0template0Contenttemplate0Contentscript0 = dochtml0head0template0Contenttemplate0Content.Childs[0] as Element;
            Assert.AreEqual(1, dochtml0head0template0Contenttemplate0Contentscript0.Childs.Length);
            ...
            var dochtml0head0template0Contenttemplate0Contentscript0Text0 = dochtml0head0template0Contenttemplate0Contentscript0.Childs[0];
        ...
        public void TemplateNodeNestedWithStyleUnclosed()
        {
            ...
            var dochtml0head0template0Contenttemplate0Contentstyle0 = dochtml0head0template0Contenttemplate0Content.Childs[0] as Element;
            Assert.AreEqual(1, dochtml0head0template0Contenttemplate0Contentstyle0.Childs.Length);
            ...
            var dochtml0head0template0Contenttemplate0Contentstyle0Text0 = dochtml0head0template0Contenttemplate0Contentstyle0.Childs[0];
        ...
        public void TemplateNodeWithTableBeforeBodySpanText()
        {
            ...
            var dochtml0head0template0Contenttable0 = dochtml0head0template0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0head0template0Contenttable0.Childs.Length);
            ...
            var dochtml0body1span0 = dochtml0body1.Childs[0] as Element;
            Assert.AreEqual(1, dochtml0body1span0.Childs.Length);
            ...
            var dochtml0body1span0Text0 = dochtml0body1span0.Childs[0];
        ...
        public void TemplateNodeWithTdBeforeBodySpanText()
        {
            ...
            var dochtml0head0template0Contenttd0 = dochtml0head0template0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0head0template0Contenttd0.Childs.Length);
        ...
        public void TemplateNodeWithObjectBeforeBodySpanText()
        {
            ...
            var dochtml0head0template0Contentobject0 = dochtml0head0template0Content.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0head0template0Contentobject0.Childs.Length);
        ...
        public void TemplateNodeWithSvgAndNestedTemplate()
        {
            ...
            var dochtml0head0template0Contentsvg0 = dochtml0head0template0Content.Childs[0] as Element;
            Assert.AreEqual(1, dochtml0head0template0Contentsvg0.Childs.Length);
            ...
            var dochtml0head0template0Contentsvg0template0 = dochtml0head0template0Contentsvg0.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0head0template0Contentsvg0template0.Childs.Length);
