...
namespace UnitTests
{
    ...
    public class PlaintextUnsafeTests
    {
        ...
        public void NullCharacterAfterHtml()
        {
            ...
            Assert.AreEqual(0, dochtml0frameset1.Childs.Length);
 ...
 <frameset></frameset>");
        ...
        public void PlaintextWithFillerText()
        {
            ...
            var dochtml0body1plaintext0 = dochtml0body1.Childs[0] as Element;
            Assert.AreEqual(1, dochtml0body1plaintext0.Childs.Length);
            ...
            var dochtml0body1plaintext0Text0 = dochtml0body1plaintext0.Childs[0];
        ...
        public void NullCharacterInCDataWithFillerInSvg()
        {
            ...
            var dochtml0body1svg0Text0 = dochtml0body1svg0.Childs[0];
        ...
        public void NullCharacterInComment()
        {
            ...
            var dochtml0body1child = dochtml0body1.Childs[0];
            Assert.AreEqual(0, dochtml0body1child.Childs.Length);
        ...
        public void NullAndOtherCharactersInComment()
        {
            ...
            var dochtml0body1Comment = dochtml0body1.Childs[0];
            Assert.AreEqual(0, dochtml0body1Comment.Childs.Length);
        ...
        public void NullCharactersInForeignObjectInSvg()
        {
            ...
            var dochtml0body1svg0foreignObject0 = dochtml0body1svg0.Childs[0] as Element;
            Assert.AreEqual(1, dochtml0body1svg0foreignObject0.Childs.Length);
            ...
            var dochtml0body1svg0foreignObject0Text0 = dochtml0body1svg0foreignObject0.Childs[0];
...
A</pre>");
            ...
            var dochtml1body1pre0 = dochtml1body1.Childs[0] as Element;
            Assert.AreEqual(1, dochtml1body1pre0.Childs.Length);
            ...
            var dochtml1body1pre0Text0 = dochtml1body1pre0.Childs[0];
...
A</pre>");
        ...
        public void NullCharacterInMathTextInMathTag()
        {
            ...
            Assert.AreEqual(1, dochtml1body1table0tbody0tr0td0math0mtext0.Childs.Length);
            ...
            var dochtml1body1table0tbody0tr0td0math0mtext0Text0 = dochtml1body1table0tbody0tr0td0math0mtext0.Childs[0];
        ...
        public void NullCharacterAfterLetterInMathNumeric()
        {
            ...
            var dochtml1body1math0mn0 = dochtml1body1math0.Childs[0] as Element;
            Assert.AreEqual(1, dochtml1body1math0mn0.Childs.Length);
            ...
            var dochtml1body1math0mn0Text0 = dochtml1body1math0mn0.Childs[0];
        ...
        public void NoFramesWithCommentInsideThatContainsAnotherNoFramesPair()
        {
            ...
            var dochtml1head0noframes0 = dochtml1head0.Childs[0] as Element;
            Assert.AreEqual(1, dochtml1head0noframes0.Childs.Length);
            ...
            var dochtml1head0noframes0Text0 = dochtml1head0noframes0.Childs[0];
        ...
        public void TextAreaWithCommentInsideThatContainsAnotherTextAreaPair()
        {
            ...
            var dochtml1body1textarea0 = dochtml1body1.Childs[0] as Element;
            Assert.AreEqual(1, dochtml1body1textarea0.Childs.Length);
            ...
            var dochtml1body1textarea0Text0 = dochtml1body1textarea0.Childs[0];
