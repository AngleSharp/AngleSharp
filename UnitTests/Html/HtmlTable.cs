...
namespace UnitTests
{
    ...
    public class HtmlTableTests
    {
        ...
        public void TableWithSingleTh()
        {
            ...
            var dochtml0body1table0tbody0tr0th0 = dochtml0body1table0tbody0tr0.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1table0tbody0tr0th0.Childs.Length);
        ...
        public void TableWithSingleTd()
        {
            ...
            Assert.AreEqual(0, dochtml0body1table0tbody0tr0td0.Childs.Length);
        ...
        public void TableWithSingleCol()
        {
            ...
            var dochtml0body1table0colgroup0col0 = dochtml0body1table0colgroup0.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1table0colgroup0col0.Childs.Length);
        ...
        public void TableWithSingleColgroupClosingHtml()
        {
            ...
            var dochtml0body1table1colgroup0 = dochtml0body1table1.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1table1colgroup0.Childs.Length);
        ...
        public void TableClosedFollowedByParagraph()
        {
            ...
            var dochtml0body1table0 = dochtml0body1.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1table0.Childs.Length);
            Assert.AreEqual(0, dochtml0body1table0.Attributes.Count);
            Assert.AreEqual("table", dochtml0body1table0.NodeName);
            Assert.AreEqual(NodeType.Element, dochtml0body1table0.NodeType);
            ...
            var dochtml0body1p1Text0 = dochtml0body1p1.Childs[0];
        ...
        public void TableWithSelectAndTable()
        {
            ...
            Assert.AreEqual(0, dochtml0body1table2.Childs.Length);
        ...
        public void TableWithSelectOptionAndContent()
        {
            ...
            Assert.AreEqual(1, dochtml0body1table1tbody0tr0td0.Childs.Length);
            ...
            var dochtml0body1table1tbody0tr0td0Text0 = dochtml0body1table1tbody0tr0td0.Childs[0];
        ...
        public void TableWithRowAndCaption()
        {
            ...
            var dochtml0body1table0tbody0tr0 = dochtml0body1table0tbody0.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1table0tbody0tr0.Childs.Length);
            Assert.AreEqual(0, dochtml0body1table0tbody0tr0.Attributes.Count);
            Assert.AreEqual("tr", dochtml0body1table0tbody0tr0.NodeName);
            Assert.AreEqual(NodeType.Element, dochtml0body1table0tbody0tr0.NodeType);

            var dochtml0body1table0caption1 = dochtml0body1table0.Childs[1] as Element;
            Assert.AreEqual(0, dochtml0body1table0caption1.Childs.Length);
        ...
        public void TableWithTdAndTr()
        {
            ...
            var dochtml0body1table0tbody0 = dochtml0body1table0.Childs[0] as Element;
            Assert.AreEqual(2, dochtml0body1table0tbody0.Childs.Length);
            Assert.AreEqual(0, dochtml0body1table0tbody0.Attributes.Count);
            Assert.AreEqual("tbody", dochtml0body1table0tbody0.NodeName);
            Assert.AreEqual(NodeType.Element, dochtml0body1table0tbody0.NodeType);
            ...
            var dochtml0body1table0tbody0tr1 = dochtml0body1table0tbody0.Childs[1] as Element;
            Assert.AreEqual(0, dochtml0body1table0tbody0tr1.Childs.Length);
        ...
        public void TableWithTdButtonAndTd()
        {
            ...
            var dochtml0body1table0tbody0tr0 = dochtml0body1table0tbody0.Childs[0] as Element;
            Assert.AreEqual(2, dochtml0body1table0tbody0tr0.Childs.Length);
            Assert.AreEqual(0, dochtml0body1table0tbody0tr0.Attributes.Count);
            Assert.AreEqual("tr", dochtml0body1table0tbody0tr0.NodeName);
            Assert.AreEqual(NodeType.Element, dochtml0body1table0tbody0tr0.NodeType);
            ...
            var dochtml0body1table0tbody0tr0td0button0 = dochtml0body1table0tbody0tr0td0.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1table0tbody0tr0td0button0.Childs.Length);
            ...
            var dochtml0body1table0tbody0tr0td1 = dochtml0body1table0tbody0tr0.Childs[1] as Element;
            Assert.AreEqual(0, dochtml0body1table0tbody0tr0td1.Childs.Length);
        ...
        public void TableWithRowCellAndSvgDescTd()
        {
            ...
            var dochtml0body1table0tbody0tr0td0svg0 = dochtml0body1table0tbody0tr0td0.Childs[0] as Element;
            Assert.AreEqual(1, dochtml0body1table0tbody0tr0td0svg0.Childs.Length);
            ...
            var dochtml0body1table0tbody0tr0td0svg0desc0 = dochtml0body1table0tbody0tr0td0svg0.Childs[0] as Element;
            Assert.AreEqual(0, dochtml0body1table0tbody0tr0td0svg0desc0.Childs.Length);
        ...
        public void TableWithTableRowThatHasStyleAndChanged()
        {
            ...
            var body = html.Childs[1] as Element;
            ...
            var table = body.Childs[0] as Element;
            ...
            var tableBody = table.Childs[0] as Element;
            Assert.AreEqual(1, tableBody.Childs.Length);
            ...
            var tableRow = tableBody.Childs[0] as Element;
            Assert.AreEqual(0, tableRow.Childs.Length);
