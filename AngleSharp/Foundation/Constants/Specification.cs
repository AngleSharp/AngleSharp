...
namespace AngleSharp
{
    ...
    static class Specification
    {
        ...
        {
            return c.IsLetter() || c == COLON || c == UNDERSCORE || c.IsInRange(0xC0, 0xD6) || c.IsInRange(0xD8, 0xF6) ||
                c.IsInRange(0xF8, 0x2FF) || c.IsInRange(0x370, 0x37D) || c.IsInRange(0x37F, 0x1FFF) || c.IsInRange(0x200C, 0x200D) ||
                c.IsInRange(0x2070, 0x218F) || c.IsInRange(0x2C00, 0x2FEF) || c.IsInRange(0x3001, 0xD7FF) || c.IsInRange(0xF900, 0xFDCF) ||
                c.IsInRange(0xFDF0, 0xFFFD) || c.IsInRange(0x10000, 0xEFFFF);
        }
        ...
        {
            return c.IsXmlNameStart() || c.IsDigit() || c == MINUS || c == DOT || c == 0xB7 ||
