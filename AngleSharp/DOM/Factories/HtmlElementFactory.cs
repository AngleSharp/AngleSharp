namespace AngleSharp.DOM.Html
{
    ...
    sealed class HtmlElementFactory : ElementFactory<HTMLElement>
    {
        ...
        HtmlElementFactory()
        {
            ...
            creators.Add(Tags.Article, document => new HTMLSemanticElement(document, Tags.Article));
            creators.Add(Tags.Aside, document => new HTMLSemanticElement(document, Tags.Aside));
            creators.Add(Tags.Figcaption, document => new HTMLSemanticElement(document, Tags.Figcaption));
            creators.Add(Tags.Figure, document => new HTMLSemanticElement(document, Tags.Figure));
            creators.Add(Tags.Section, document => new HTMLSemanticElement(document, Tags.Section));
            creators.Add(Tags.Footer, document => new HTMLSemanticElement(document, Tags.Footer));
            creators.Add(Tags.Header, document => new HTMLSemanticElement(document, Tags.Header));
            creators.Add(Tags.Hgroup, document => new HTMLSemanticElement(document, Tags.Hgroup));
            creators.Add(Tags.Plaintext, document => new HTMLSemanticElement(document, Tags.Plaintext));
            creators.Add(Tags.Bgsound, document => new HTMLBgsoundElement(document));
            creators.Add(Tags.Marquee, document => new HTMLMarqueeElement(document));
            creators.Add(Tags.NoEmbed, document => new HTMLNoEmbedElement(document));
