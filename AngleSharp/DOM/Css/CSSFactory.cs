namespace AngleSharp.DOM.Css
{
    ...
    internal class CSSFactory
    {
        ...
        static CSSFactory()
        {
            ...
            properties.Add(PropertyNames.BorderStyle, () => new CSSBorderStyleProperty());
            ...
            properties.Add(PropertyNames.BorderImage, () => new CSSBorderImageProperty());
            properties.Add(PropertyNames.BorderImageOutset, () => new CSSBorderImageOutsetProperty());
            properties.Add(PropertyNames.BorderImageRepeat, () => new CSSBorderImageRepeatProperty());
            properties.Add(PropertyNames.BorderImageSource, () => new CSSBorderImageSourceProperty());
            properties.Add(PropertyNames.BorderImageSlice, () => new CSSBorderImageSliceProperty());
            properties.Add(PropertyNames.BorderImageWidth, () => new CSSBorderImageWidthProperty());
            properties.Add(PropertyNames.BorderTopColor, () => new CSSBorderTopColorProperty());
            properties.Add(PropertyNames.BorderLeftColor, () => new CSSBorderLeftColorProperty());
            properties.Add(PropertyNames.BorderRightColor, () => new CSSBorderRightColorProperty());
            properties.Add(PropertyNames.BorderBottomColor, () => new CSSBorderBottomColorProperty());
            properties.Add(PropertyNames.BorderTopStyle, () => new CSSBorderTopStyleProperty());
            properties.Add(PropertyNames.BorderLeftStyle, () => new CSSBorderLeftStyleProperty());
            properties.Add(PropertyNames.BorderRightStyle, () => new CSSBorderRightStyleProperty());
            properties.Add(PropertyNames.BorderBottomStyle, () => new CSSBorderBottomStyleProperty());
            properties.Add(PropertyNames.BorderTopWidth, () => new CSSBorderTopWidthProperty());
            properties.Add(PropertyNames.BorderLeftWidth, () => new CSSBorderLeftWidthProperty());
