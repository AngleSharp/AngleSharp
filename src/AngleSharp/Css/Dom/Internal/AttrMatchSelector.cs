namespace AngleSharp.Css.Dom
{
    ...
    sealed class AttrMatchSelector : BaseAttrSelector, ISelector
    {
        ...
        public AttrMatchSelector(String name, String value, String? prefix = null, Boolean insensitive = false, AttributeSelectorCaseSensitivity caseSensitivity = AttributeSelectorCaseSensitivity.Auto)
