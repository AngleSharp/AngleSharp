namespace AngleSharp.Css.Dom
{
    ...
    sealed class AttrNotMatchSelector : BaseAttrSelector, ISelector
    {
        ...
        public AttrNotMatchSelector(String name, String value, String? prefix = null, Boolean insensitive = false, AttributeSelectorCaseSensitivity caseSensitivity = AttributeSelectorCaseSensitivity.Auto)
