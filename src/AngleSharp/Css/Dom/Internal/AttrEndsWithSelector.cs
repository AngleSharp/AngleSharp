namespace AngleSharp.Css.Dom
{
    ...
    sealed class AttrEndsWithSelector : BaseAttrSelector, ISelector
    {
        ...
        public AttrEndsWithSelector(String name, String value, String? prefix = null, Boolean insensitive = false, AttributeSelectorCaseSensitivity caseSensitivity = AttributeSelectorCaseSensitivity.Auto)
