namespace AngleSharp.Css.Dom
{
    ...
    sealed class AttrInListSelector : BaseAttrSelector, ISelector
    {
        ...
        public AttrInListSelector(String name, String value, String? prefix = null, Boolean insensitive = false, AttributeSelectorCaseSensitivity caseSensitivity = AttributeSelectorCaseSensitivity.Auto)
