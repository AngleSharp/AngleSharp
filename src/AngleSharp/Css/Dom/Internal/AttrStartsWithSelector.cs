namespace AngleSharp.Css.Dom
{
    ...
    sealed class AttrStartsWithSelector : BaseAttrSelector, ISelector
    {
        ...
        public AttrStartsWithSelector(String name, String value, String? prefix = null, Boolean insensitive = false, AttributeSelectorCaseSensitivity caseSensitivity = AttributeSelectorCaseSensitivity.Auto)
